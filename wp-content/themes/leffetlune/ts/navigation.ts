...
export class Navigation
{
     ...
     */
    constructor(navSelector: string, menuSelector: string, menuItemSelector: string, btnSelector:string, private openClass:string, private transitionTrigger: string = "right")
    {
    ...
    {        
        if(!this.menuItems || e.propertyName != this.transitionTrigger || !this.open || !this.burgerBtn)return;
